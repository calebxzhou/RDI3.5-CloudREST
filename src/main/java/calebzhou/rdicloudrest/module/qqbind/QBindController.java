...
public class QBindController {
    ...
    @RequestMapping(value = "/qbind/{qq}",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/qbind/{number}/{pid}",method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/qbind/{pid}",method = RequestMethod.DELETE)

...
public class Island2Ctrler {
    ...
    public Object getIsland(/*@RequestHeader("rauth") String token,*/@PathVariable String pid){
        ...
        if(!playerOwnIsland && !playerJoinAnyIsland){
            return ResponseCode.sourceNotJoinAnyIsland;
        }
        Integer iid;
        if(playerOwnIsland){
    ...
    public Object deleteIsland(/*@RequestHeader("rauth") String token,*/@PathVariable String pid, HttpServletRequest request){
        ...
        //没岛不删
        if(!mapper.isPlayerOwnIsland(pid)){
            return ResponseCode.sourceNotOwnIsland;
        }
    ...
    public ResponseCode transferIsland(/*@RequestHeader("rauth") String token,*/@PathVariable String pid, @PathVariable String targetPid){
    ...
    public ResponseCode changeLocation(/*@RequestHeader("rauth") String token,*/@PathVariable String pid, @RequestParam double x, @RequestParam double y, @RequestParam double z,
    ...
    public ResponseCode addMember(/*@RequestHeader("rauth") String token,*/@PathVariable String pid, @PathVariable String mpid){
        //没岛不加
        if(!mapper.isPlayerOwnIsland(pid))
            return ResponseCode.sourceNotOwnIsland;
        //不能添加自己
    ...
    public ResponseCode removeMember(/*@RequestHeader("rauth") String token*//*,@PathVariable String pid,*/@PathVariable String mpid){
        //自己没有岛 不删
        /*if(!mapper.isPlayerOwnIsland(pid))
        ...
        //目标没进任何岛 不删
        if(!mapper.isPlayerJoinAnyIsland(mpid))
            return ResponseCode.targetNotJoinAnyIsland;
